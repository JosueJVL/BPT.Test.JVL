...
namespace BPT.Test.JVL.FrontEnd.Client.Client
{
    class DetailStudent
    {
        ...
        {
            Console.WriteLine("******* D E T A L L E    DE   A S I G N A C I O N E S  POR  ID   E S T U D I A N T E  *******");
            Console.WriteLine("*******    (1)Consultar, (2)Consulta por Id Estudiante, (3)Salir *******");
            ...
            switch (operation)
            {
                case 1:
                    ...
                    break;
                case 2:
                    Console.WriteLine("Ingresa el ID del Estdiante ");
        ...
        private void Get()
        {
            var student = new ServiceClient(" DetailStudent");
